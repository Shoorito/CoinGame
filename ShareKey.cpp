...
void S_KeyStore::initKey()
{
	...
	arUseCoinName[(int)E_COIN::E_STANDARD]			= u8"½ºÅÄ´ÙµåÄÚÀÎ(SDC)";
	arUseCoinName[(int)E_COIN::E_EATERIUM]			= u8"ÀÌÅÍ¸®¿ò(ETR)";
	arUseCoinName[(int)E_COIN::E_ATOM]				= u8"¾ÆÅè(ATM)";
	arUseCoinName[(int)E_COIN::E_VILLAIN]			= u8"ºô·±(VLN)";
	arUseCoinName[(int)E_COIN::E_STANDARD_PRIME]	= u8"½ºÅÄ´ÙµåÇÁ¶óÀÓ(SDP)";
	arUseCoinName[(int)E_COIN::E_COMMENT]			= u8"ÄÚ¸àÆ®(CMT)";
	arUseCoinName[(int)E_COIN::E_TOUR_CREDIT]		= u8"Åõ¾îÅ©·¹µ÷(TCD)";
	arUseCoinName[(int)E_COIN::E_EDIT_CREDIT]		= u8"¿¡µ÷Å©·¹µ÷(ECD)";
	arUseCoinName[(int)E_COIN::E_TYPHOON_TOKEN]		= u8"Å¸ÀÌÇ¬ÅäÅ«(TPT)";
	arUseCoinName[(int)E_COIN::E_DISCREET]			= u8"µð½ÃÅ©¸´(DSC)";
